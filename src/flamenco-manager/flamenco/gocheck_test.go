...
func ConstructTestTask(taskID, JobType string) Task {
	return ConstructTestTaskWithPrio(taskID, JobType, 50)
}

func ConstructTestTaskWithPrio(taskID, JobType string, priority int) Task {
	return Task{
